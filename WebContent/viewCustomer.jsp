...
<body class="body">
<form name="form1" action="BookingFlightDetails.jsp"  method="post">
...
String cid,First_Name,Last_Name,Birth_Date,Email_ID,Phone_No,Address;
		...
		{   
            ...
            request.setAttribute("Address",Address);
					...
					Source</td>
					<td>
					<input type="text" name="source" class="input" value=""/>
					</td>
					</tr>
					<tr>
					<td>
					Destination</td>
					<td>
					<input type="text" name="destin" class="input" value=""/>
					</td>
					</tr>
					...
					<td colspan="2">
					<input type="submit" value="View Details" name="Update" class="myButton"/>
