...
<body class="body">
 <form name="form1" action="delEmployeeDetails.jsp"  method="post">
<%
...
//It will throw the the error if occured
		...
		{   
			...
			//Creating SQL staements to select all the data from UserDetail 
		    
			Statement st=con.createStatement();
		    ResultSet rs=st.executeQuery("select * from m_sing_User_Detail");
         %>
 ...
 <TABLE Border="1">
           <tr><h2><strong>Details of the customer in the database</strong></h2></tr>
            <TR>             
             ...
             <% 
            		 while(rs.next()){
            			 ...
            			 //Variable declared to accept an input choice as value
            ...
            <TR>
                    ...
                    <td><input type="radio" name="delete" value="<%= eno%>"></td>
