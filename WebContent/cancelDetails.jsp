...
//It will throw the the error if occured
		...
		{   
		    ...
		    ResultSet rs=st.executeQuery("select * from m_sing_Cancellation_Details ");
           ...
           <TABLE Border=1 bordercolor="purple" bgcolor=#85929E >
            <TR>        
               ...
               <TH><font color="white">Departure Time</font></TH>
                ...
                <TH><font color="white">Date of Cancellation</font></TH> 
            ...
            <TR>
              ...
              <TD><font color="white"> <%= rs.getString(14) %></font></td>
                </TR>
